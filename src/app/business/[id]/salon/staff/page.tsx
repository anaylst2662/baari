...
import { addStaff, updateStaff } from "@/lib/actions/business";
import { SubmitButton } from "@/components/client";
import { Empty } from "@/components/ui";

/** My Salon → Staff, with "on duty" toggles (used for wait times and booking capacity). */
export default async function BusinessStaff({ params }: PageProps<"/business/[id]/salon/staff">) {
  ...
  return (
    <section className="space-y-3">
      <SectionHeader salonId={salon.id} title={t.staff} backLabel={t.mySalon} />
      <p className="text-sm text-slate-600">{t.staffHelp}</p>
