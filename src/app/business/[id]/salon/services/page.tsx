...
import { addService, updateService } from "@/lib/actions/business";
import { SubmitButton } from "@/components/client";
import { SectionHeader } from "@/experiences/business/section-header";

export default async function BusinessServices({ params }: PageProps<"/business/[id]/salon/services">) {
  ...
  return (
    <div className="space-y-4">
      <SectionHeader salonId={salon.id} title={t.navPrices} backLabel={t.mySalon} />
      {categoryList}
